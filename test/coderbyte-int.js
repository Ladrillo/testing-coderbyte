...
module.exports = function () {
    ...
    describe('helper function combinations', function () {
        it('should do first round of agreggations', function () {
            expect(combinations([[1], [2], [3], [4]])).to.eql([[1, 2], [1, 3], [1, 4], [2, 3], [2, 4], [3, 4]]);
        });
    });

    describe('helper function doFirst', function () {
        it('should do the first element only', function () {
            expect(doFirst([1, 2, 3, 4], [])).to.equal([[1], [1, 2], [1, 3], [1, 4], [1, 2, 3], [1, 2, 4], [1, 3, 4], [1, 2, 3, 4]]);
        });
    });
